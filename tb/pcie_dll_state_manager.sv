...
class pcie_dll_state_manager extends uvm_component;
    `uvm_component_utils(pcie_dll_state_manager);

    uvm_analysis_imp #(dllp_item, pcie_dll_state_manager) dllp_export; //connected to the monitor on the agent level
    ...
    function new(string name = "pcie_dll_state_manager", uvm_component parent = null);
